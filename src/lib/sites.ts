/**
 * The oriz family — single source of truth for cross-site links shown in the
 * footer family list, the search dropdown, and any "more from oriz" surfaces.
 * Mirrors the same shape used by oriz-home/src/lib/sites.ts.
 */
